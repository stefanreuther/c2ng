...
AFL_TEST("game.ExperienceLevelSet:formatExperienceLevelSet:errors", a)
{
    ...
    (*config)[game::config::HostConfiguration::NumExperienceLevels].set(0);
    ...
    (*config)[game::config::HostConfiguration::NumExperienceLevels].set(3);
...
AFL_TEST("game.ExperienceLevelSet:formatExperienceLevelSet", a)
{
    afl::string::NullTranslator tx;
    afl::base::Ref<game::config::HostConfiguration> config = game::config::HostConfiguration::create();
    (*config)[game::config::HostConfiguration::NumExperienceLevels].set(5);
