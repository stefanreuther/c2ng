/**
  *  \file test/game/vcr/classic/standardschedulertest.cpp
  *  \brief Test for game::vcr::classic::StandardScheduler
  */
...
AFL_TEST("game.vcr.classic.StandardScheduler:placeObject", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateTime", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:startFighter", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
    ...
    mock.assertEvent("WaitAnimation(*,*,*,*,*,*)");          // not strictly required
    mock.assertEvent("UpdateTime(*,500,*,*,*,*)");
    mock.assertEvent("UpdateDistance(*,3000,*,*,*,*)");
    mock.assertEvent("WaitTick(*,*,*,*,*,*)");
    mock.assertFinish();
...
AFL_TEST("game.vcr.classic.StandardScheduler:landFighter", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:killFighter", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:fireBeam:s/s", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:fireBeam:s/f", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:fireBeam:f/s", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:fireBeam:f/f", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:fireTorpedo", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
    ...
    testee.fireTorpedo(game::vcr::classic::RightSide, 8, 5, -1, eff);
    testee.updateTime(500, 3000);

    mock.assertEvent("FireTorpedo(1,5,10,*,6,*)");
    mock.assertEvent("UpdateNumTorpedoes(1,-1,*,*,*,*)");
    mock.assertEvent("FireTorpedo(1,5,8,*,6,*)");
    mock.assertEvent("UpdateNumTorpedoes(1,-1,*,*,*,*)");
    mock.assertEvent("WaitAnimation(*,*,*,*,*,*)");
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateBeam", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateLauncher", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:moveObject", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:moveFighter", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:killObject", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateObject", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateAmmo", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:updateFighter", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:setResult", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
...
AFL_TEST("game.vcr.classic.StandardScheduler:removeAnimations", a)
{
    TestScheduledEventConsumer mock(a);
    game::vcr::classic::StandardScheduler testee(mock);
