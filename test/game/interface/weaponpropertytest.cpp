...
AFL_TEST("game.interface.WeaponProperty", a)
{
    ...
    afl::base::Ref<game::config::HostConfiguration> configAC0 = game::config::HostConfiguration::create();
    afl::base::Ref<game::config::HostConfiguration> configAC1 = game::config::HostConfiguration::create();
