...
section('Commands',
        ...
        paragraph_detail('<b>cat</b> <i>FILE</i>...',
                         paragraph_text('Dump content of <i>FILE</i> to standard output;')),
        ...
        paragraph_detail('<b>snapshot</b> <i>PATH</i> <b>ls</b> [<b>-l</b>]',
                         paragraph_text('List snapshots on CA file system in path <i>PATH</i>;')),
        paragraph_detail('<b>snapshot</b> <i>PATH</i> <b>add</b> <i>NAME</i>...',
                         paragraph_text('Create snapshots of current status on CA file system in path <i>PATH</i>.',
                                        'If a snapshot name already exists, it is overwritten;')),
        paragraph_detail('<b>snapshot</b> <i>PATH</i> <b>rm</b> <i>NAME</i>...',
                         paragraph_text('Remove snapshots from on CA file system in path <i>PATH</i>.',
                                        'If the given names do not exist, the command is ignored;')),
        paragraph_detail('<b>snapshot</b> <i>PATH</i> <b>cp</b> <i>OLD</i> <i>NEW</i>...',
                         paragraph_text('Copy snapshots on CA file system in path <i>PATH</i>.',
                                        'The new names will refer to the same content as the old one.',
                                        'If a snapshot name already exists, it is overwritten;')),
        paragraph_detail('<b>snapshot</b> <i>PATH</i> <b>restore</b> <i>NAME</i>',
                         paragraph_text('Restore content of CA file system in path <i>PATH</i> from the given snapshot.')));
...
subsect('File Specifications',
        ...
        paragraph_detail('[<i>PATH</i><b>@</b>]<b>snapshot:</b><i>NAME</i><b>:</b><i>SPEC</i>',
                         paragraph_text('Snapshot in an unmanaged, content-addressable file system (read-only);')),
