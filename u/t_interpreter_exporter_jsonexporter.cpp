/**
  *  \file u/t_interpreter_exporter_jsonexporter.cpp
...
/** Simple test. */
void
TestInterpreterExporterJsonExporter::testIt()
{
    ...
    TS_ASSERT_EQUALS(trimNewlines(afl::string::fromBytes(outputStream.getContent())),
                     "[{\"left\":1,\"right\":\"a\"},"
                     "{\"left\":2,\"right\":\"Say \\\"hi\\\"!\"},"
...
/** Test empty table. */
void
TestInterpreterExporterJsonExporter::testEmpty()
{
    // Prepare a field list
    interpreter::exporter::FieldList list;
    list.addList("left,right");
...
void
TestInterpreterExporterJsonExporter::testArray()
{
    // Prepare a field list
    interpreter::exporter::FieldList list;
    list.addList("a,b");
