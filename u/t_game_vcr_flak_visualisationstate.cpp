...
TestGameVcrFlakVisualisationState::testShip()
{
    ...
    testee.createShip(1, Position(1000, 2000, 0), 3, false);
    testee.createShip(2, Position(1000, -5000, 10), 4, true);
...
TestGameVcrFlakVisualisationState::testShipTurn()
{
    ...
    testee.createShip(1, Position(1000, 1000, 0), 3, false);
    testee.createShip(2, Position(1000, -1000, 0), 4, true);
    testee.createFleet(0, 1000, 2000, 3, 1, 1);
