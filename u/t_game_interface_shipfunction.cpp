/**
  *  \file u/t_game_interface_shipfunction.cpp
...
/** General tests. */
void
TestGameInterfaceShipFunction::testIt()
{
    // Environment
    ...
    TS_ASSERT_EQUALS(testee.getDimension(1), 101);     // last ship Id, plus 1
...
void
TestGameInterfaceShipFunction::testNull()
{
    afl::string::NullTranslator tx;
    afl::io::NullFileSystem fs;
