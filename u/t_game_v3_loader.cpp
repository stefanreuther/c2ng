...
void
TestGameV3Loader::testGameNamePConfig()
{
    // Prepare
    TestHarness h;
    ...
    // Verify
    TS_ASSERT_EQUALS(h.root.hostConfiguration()[game::config::HostConfiguration::GameName](), "testGameNamePConfig");
}

/** Test loadConfiguration(), set game name from directory name. */
void
TestGameV3Loader::testGameNameFromDirectory()
{
    // Prepare
    TestHarness h;
    afl::io::InternalFileSystem fs;
    ...
    // Verify
    TS_ASSERT_EQUALS(h.root.hostConfiguration()[game::config::HostConfiguration::GameName](), "vpwork3");
}

/** Test loadConfiguration(), set game name from gamestat.dat file. */
void
TestGameV3Loader::testGameNameFromGamestat()
{
    ...
    // Verify
    TS_ASSERT_EQUALS(h.root.hostConfiguration()[game::config::HostConfiguration::GameName](), "Game  3");
}
