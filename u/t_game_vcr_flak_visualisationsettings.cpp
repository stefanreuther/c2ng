...
TestGameVcrFlakVisualisationSettings::testFollowFleet()
{
    ...
    st.createShip(1, Position(1000, 2000, 0), 3, false);
    st.createShip(2, Position(1000, -5000, 10), 4, true);
...
TestGameVcrFlakVisualisationSettings::testFollowDead()
{
    // Environment
    game::vcr::flak::VisualisationState st;
    st.createShip(0, Position(1000, 2000, 0), 3, false);
    st.createShip(1, Position(2000, 3000, 0), 4, true);
    st.createShip(2, Position(3000, 4000, 0), 3, false);
    st.createShip(3, Position(4000, 5000, 0), 3, false);
...
TestGameVcrFlakVisualisationSettings::testFollowDead2()
{
    ...
    st.createShip(0, Position(1000, 2000, 0), 3, false);
    st.createShip(1, Position(2000, 3000, 0), 4, true);
    st.createShip(2, Position(3000, 4000, 0), 4, false);
    st.createShip(3, Position(4000, 5000, 0), 5, false);
    st.createFleet(0, 1000, 2000, 3, 0, 1);
    st.createFleet(1, 2000, 3000, 4, 1, 1);
