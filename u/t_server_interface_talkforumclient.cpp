...
TestServerInterfaceTalkForumClient::testIt()
{
    ...
    // getInfo
    {
        ...
        mock.provideReturnValue(new HashValue(ret));
    ...
    // getInfo
    {
        ...
        mock.provideReturnValue(new VectorValue(retArray));
    ...
    // getThreads
    {
        ...
        mock.provideReturnValue(new VectorValue(Vector::create(Segment().pushBackInteger(1).pushBackInteger(3))));
    ...
    }
    {
        ...
        mock.provideReturnValue(new VectorValue(Vector::create(Segment().pushBackInteger(11).pushBackInteger(13))));
    ...
    // getPosts
    {
        ...
        mock.provideReturnValue(new VectorValue(Vector::create(Segment().pushBackInteger(1).pushBackInteger(3).pushBackInteger(8))));
