...
TestGfxCodecCustom::testSave()
{
    ...
    // 4-bit uncompressed
    {
        ...
        TS_ASSERT_EQUALS(out.getContent().size(), sizeof(EXPECTED));
        TS_ASSERT_SAME_DATA(out.getContent().unsafeData(), EXPECTED, sizeof(EXPECTED));
    }
