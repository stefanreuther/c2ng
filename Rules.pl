...
if (get_variable('ENABLE_BUILD')) {
    ...
    my @CONSOLE_APPS = qw(c2check c2compiler c2configtool c2docmanager c2export c2mgrep c2mkturn c2plugin c2rater c2script c2simtool c2sweep c2unpack c2untrn c2gfxgen);
