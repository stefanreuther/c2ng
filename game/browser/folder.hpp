    ...
    class Folder : public afl::base::Deletable {
     public:
        ...
        /** Load folder configuration.
            ...
            - If this is a local storage folder, should load the configuration file and return true.
        ...
        /** Load game root.
            ...
            \return root, if any */
        virtual afl::base::Ptr<Root> loadGameRoot(const game::config::UserConfiguration& config) = 0;
