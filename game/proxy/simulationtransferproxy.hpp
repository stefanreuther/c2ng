...
namespace game { namespace proxy {
    ...
    class SimulationTransferProxy {
     public:
        ...
        bool hasObject(util::WaitIndicator& ind, Reference ref);
        ...
        bool copyObjectFromGame(util::WaitIndicator& ind, Reference ref);

        /** Copy objects from game into simulation.
            \param ind  WaitIndicator for UI synchronisation
            \param list List of objects
            \return number of objects successfully copied */
        size_t copyObjectsFromGame(util::WaitIndicator& ind, const game::ref::List& list);
