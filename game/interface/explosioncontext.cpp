...
void
game::interface::ExplosionContext::set(PropertyIndex_t /*index*/, afl::data::Value* /*value*/)
{
...
void
game::interface::ExplosionContext::store(interpreter::TagNode& /*out*/, afl::io::DataSink& /*aux*/, afl::charset::Charset& /*cs*/, interpreter::SaveContext& /*ctx*/) const
{
