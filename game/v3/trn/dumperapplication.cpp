...
game::v3::trn::DumperApplication::showHelp()
{
    ...
    afl::string::Translator& tx = translator();
    w.writeLine(Format(tx("Turn File Decompiler v%s - (c) 2001-2024 Stefan Reuther").c_str(), PCC2_VERSION));
...
game::v3::trn::DumperApplication::showVersion()
{
    ...
    standardOutput().writeLine(Format(translator()("Turn File Decompiler v%s - (c) 2001-2024 Stefan Reuther").c_str(), PCC2_VERSION));
    exit(0);
}
