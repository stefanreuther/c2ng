/**
  *  \file client/proxy/planetinfoproxy.hpp
  *  \brief Class client::proxy::PlanetInfoProxy
  */
#ifndef C2NG_CLIENT_PROXY_PLANETINFOPROXY_HPP
#define C2NG_CLIENT_PROXY_PLANETINFOPROXY_HPP
...
namespace client { namespace proxy {
    ...
    class PlanetInfoProxy {
     public:
        ...
        PlanetInfoProxy(util::RequestSender<game::Session> gameSender, util::RequestDispatcher& receiver);
        ...
        /** Set planet Id.
            ...
            \param id Planet Id */
        void setPlanet(game::Id_t id);

        /** Set number of buildings.
            \param type Type
            \param amount Number of buildings (Nothing to use planet's amount) */
        void setBuildingOverride(game::PlanetaryBuilding type, game::IntegerProperty_t amount);
