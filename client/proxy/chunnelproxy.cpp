/**
  *  \file client/proxy/chunnelproxy.cpp
...
using client::proxy::ChunnelProxy;
using game::Game;
using game::Id_t;
using game::Root;
...
bool
client::proxy::ChunnelProxy::Candidate::operator==(const Candidate& b) const
{
    return pos == b.pos;
}
...
bool
client::proxy::ChunnelProxy::CandidateList::operator==(const CandidateList& b) const
{
...
// Constructor.
client::proxy::ChunnelProxy::ChunnelProxy(util::RequestDispatcher& reply, util::RequestSender<game::Session> gameSender)
    : m_gameSender(gameSender),
      m_reply(reply, *this)
{ }

// Destructor.
client::proxy::ChunnelProxy::~ChunnelProxy()
{ }

// Asynchronous request for possible chunnel targets.
void
client::proxy::ChunnelProxy::postCandidateRequest(game::Id_t shipId)
{
    /* Reply (Session -> UI) */
    class Reply : public util::Request<ChunnelProxy> {
     public:
        Reply(game::Session& session, Id_t shipId)
            : m_result()
...
void
client::proxy::ChunnelProxy::getCandidates(Downlink& link, game::Id_t shipId, game::map::Point pos, game::ref::UserList& list)
{
    class Query : public util::Request<game::Session> {
     public:
...
client::proxy::ChunnelProxy::setupChunnel(Downlink& link, game::Id_t fromShipId, game::Id_t toShipId)
{
    class Query : public util::Request<game::Session> {
     public:
